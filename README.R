...
## The numerbs show a small change in the values between early projects and late projects:
## the mean duration has increased from 604 to 679,
...
## After the removal of PPTA projects, the fractions of the higher-ranked projects (2,3) have increased due to the nature of
## PPTA projects, as described above.
...
## while the control group would be receving a normal budget, given everything else stays untouched.
...
## control the counfounding variables and see the direct impact of a certain variable to try to imply causation,
## which is almost impossible to do with observational data because of the influence of the counfouding variables.
